        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="bg-white/80 rounded-xl p-3 text-center border border-amber-100">
              <p className="text-[10px] font-bold uppercase text-gray-500">Price Match (5%)</p>
              <p className="text-xl font-mono font-bold text-amber-600">{kpiData.price_margin_sales_count || 0} sales</p>
              <p className="text-[9px] text-gray-400">{kpiData.closed_deals > 0 ? ((kpiData.price_margin_sales_count || 0) / kpiData.closed_deals * 100).toFixed(1) : 0}% of deals</p>
            </div>
            <div className="bg-white/80 rounded-xl p-3 text-center border border-amber-100">
              <p className="text-[10px] font-bold uppercase text-gray-500">Price Match Revenue</p>
